...
// Re-export event topics, types, and schema version from shared contracts so
// user module code can import from its own domain package. This is the canonical
// import path within the user module. Other modules (audit, notification) MUST
// import from contracts/ directly — never from another module's domain/.

// EventSchemaVersion is the current schema version for user domain events.
