...
var (
	...
	ErrPasswordRequired = sharederr.New(sharederr.CodeInvalidArgument, "hashed password is required")
	ErrInvalidArgument  = sharederr.New(sharederr.CodeInvalidArgument, "invalid argument")
