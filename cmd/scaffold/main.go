...
func main() {
	...
	files := []fileMapping{
		...
		{"adapter_postgres_mapper.tmpl", filepath.Join("internal", "modules", data.Name, "adapters", "postgres", "mapper.go")},
		...
		{"adapter_grpc_handler_test.tmpl", filepath.Join("internal", "modules", data.Name, "adapters", "grpc", "handler_test.go")},
